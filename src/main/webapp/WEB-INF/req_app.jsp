...
<table>
  ...
  <tr>
    ...
    <td> <a href="/SpringSecurityHelloWorlExample/Appointment/edit/${appoint.amka}">Edit </a></td>
    <td><a href="<c:url value='/Appointment/remove/${appoint.amka}'/> " > Delete </a></td>
    <td> <a href="/SpringSecurityHelloWorlExample/Appointment/set/${appoint.amka}">Save </a></td>
